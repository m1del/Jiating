function EventTile({ size, gridPos }) {
  ...
  if (size == 'large') {
    ...
    return (
      <div className={eventClass}>
        <div className="to-transparent absolute h-full w-full bg-gradient-to-t from-black opacity-70">
    ...
    return (
      <div className={eventClass}>
        <div className="relative flex h-full w-full items-center justify-center">
          ...
          <div className="absolute left-[22rem] ml-9 flex h-full w-[52.5%] flex-col items-center justify-center rounded-2xl rounded-l-none bg-black-rgba px-4 text-center">
            <h2 className="pb-4 text-2xl">CNY 2023</h2>
