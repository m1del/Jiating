...
const styles: StyleDefinition = {
  ...
  button: "bg-cyan-600 hover:bg-cyan-800 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200 ease-in-out transform hover:-translate-y-1",
};
